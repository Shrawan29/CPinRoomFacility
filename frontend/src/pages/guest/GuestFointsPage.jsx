...
const perks = [
  ...
  { value: "30%",    label: "Birthday & Anniversary",       sub: "cashback during your special weeks", color: "#5f8a2e" },
];
      ...
      <style>{`
        ...
        * { box-sizing: border-box; -webkit-font-smoothing: antialiased; }
        ...
        .fp-section-label::before {
          ...
          background: #0e8a83; opacity: 0.62;
        }
        ...
        /* definition card */
        .fp-def-card {
          background: linear-gradient(135deg, rgba(255,255,255,0.97), rgba(255,245,188,0.80));
          border: 1.2px solid rgba(255,255,255,0.74);
          border-radius: 18px;
          padding: 18px 20px;
        ...
        .fp-def-card::before {
          ...
          background: linear-gradient(135deg, #0b918a, #11b2aa);
        ...
        .fp-def-body {
          font-size: 13px; color: #3d4339; line-height: 1.6; margin: 0 0 10px;
        }
        .fp-eq {
        ...
        .fp-eq-left  { font-size: 14px; font-weight: 600; color: #0a8c85; }
        .fp-eq-sep   { font-size: 16px; color: #678233; }
        .fp-eq-right { font-size: 14px; font-weight: 600; color: #0b5f59; }
        ...
        .fp-perk-sub   { font-size: 8px; color: #6f6a4b; line-height: 1.35; }
        ...
        .fp-privileges::before {
          content: ''; position: absolute;
          top: 0; left: 0; right: 0; height: 2.5px;
          background: linear-gradient(135deg, #0b918a, #127971);
          border-radius: 18px 18px 0 0;
        }
        .fp-priv-item {
        ...
        .fp-priv-dot {
          ...
          background: #0b918a; flex-shrink: 0; margin-top: 5px;
        }
        ...
        .fp-contact {
          text-align: center;
          padding: 16px;
          background: linear-gradient(to bottom, rgba(255,255,255,0.93), rgba(255,247,202,0.80));
          border: 1.2px solid rgba(255,255,255,0.6);
          border-radius: 16px;
          box-shadow: 0 3px 12px rgba(26,20,16,0.06);
        }
        .fp-contact a {
          color: #0a8d86; text-decoration: none; font-weight: 600;
        }
