...
export default function GuestFointsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-purple-50 flex flex-col items-center py-8 px-2">
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-lg p-6">
        <div className="flex flex-col items-center mb-6">
          <img src={logo} alt="Centre Point Logo" className="h-14 mb-2" />
          <h1 className="text-2xl font-bold text-yellow-500 mb-2 text-center">Foints Loyalty Program</h1>
          <p className="text-base text-gray-700 text-center">Your Food Points by Centre Point Hospitality</p>
        </div>

        {/* What are Foints? */}
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-blue-700 mb-2">What are Foints?</h2>
        ...
        {/* How it works */}
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-purple-700 mb-2">How does it work?</h2>
        ...
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-blue-700 mb-2">Where can I use Foints?</h2>
        ...
        {/* Privileges */}
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-yellow-600 mb-2">Privileges & Benefits</h2>
          <ul className="list-disc pl-6 text-gray-800">
        ...
        {/* Quick Links */}
        <section className="mb-8">
          <h2 className="text-lg font-semibold text-green-700 mb-2">Quick Links</h2>
